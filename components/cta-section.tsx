      ...
      <div className="relative z-10 flex flex-col justify-start items-center gap-9 max-w-4xl mx-auto">
        <div className="flex flex-col justify-start items-center gap-4 text-center">
          ...
          <p className="text-muted-foreground text-sm md:text-base font-medium leading-[18.20px] md:leading-relaxed break-words max-w-2xl">
            Descubre cómo miles de personas en Bolivia han transformado su comportamiento financiero con SACF. Tu viaje hacia la libertad financiera comienza hoy.
          </p>
        </div>
        <Link href="/register">
          <Button
            className="px-[30px] py-2 bg-primary text-primary-foreground text-sm font-bold uppercase tracking-widest leading-6 rounded-[99px] shadow-lg hover:bg-primary-dark transition-all duration-200 hover:scale-105 active:scale-95"
            size="lg"
          >
